...
const Visit = () => {
  ...
  return (
    <section className="pt-32 pb-20 min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[var(--gold-light)] via-white to-blue-100 relative overflow-hidden">
      <div className="max-w-3xl w-full mx-auto px-6 z-10">
        <div className="text-center animate-fade-in">
          <h1 className="text-4xl md:text-5xl font-bold text-[var(--royal-blue-dark)] mb-4">Plan a Visit</h1>
