  ...
  return (
    <section id="about" className="py-20 bg-white px-6">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          <p className="eyebrow text-[var(--royal-blue)]"> Our foundation</p>
          ...
          <p className="text-gray-700 text-lg leading-relaxed">From weekly services to special vigils, our church provides opportunities to grow spiritually, connect with others, and make a difference in our world.</p>
