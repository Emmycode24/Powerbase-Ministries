  ...
  return (
    <section id="about" className="py-20 bg-white px-6">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <img src="/powerbase-logo.jpg" alt="About Powerbase Ministries" className="w-full max-w-md mx-auto rounded-2xl shadow-lg" />
        <div>
          ...
          <a href="/about" className="inline-block mt-6 font-semibold text-purple-800 hover:text-purple-950">Learn More About Us →</a>
        </div>
      </div>
    </section>
  );
