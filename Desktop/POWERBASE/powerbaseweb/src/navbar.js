  ...
  return (
    <nav className="fixed top-0 left-0 right-0 w-full bg-white/95 backdrop-blur-sm shadow-md z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-3">
        <a href={process.env.PUBLIC_URL || "/"} className="flex items-center gap-3 text-xl font-bold text-purple-900">
        ...
        <div className="hidden md:flex items-center gap-7 text-gray-700 font-medium text-sm">
          <a href={process.env.PUBLIC_URL || "/"} className="hover:text-purple-800">Home</a>
          <a href={`${process.env.PUBLIC_URL}/#/about`} className="hover:text-purple-800">About</a>
          <a href={`${process.env.PUBLIC_URL}/#/events`} className="hover:text-purple-800">Events</a>
          <a href={`${process.env.PUBLIC_URL}/#/contact`} className="hover:text-purple-800">Contact</a>
          <a href={`${process.env.PUBLIC_URL}/#/visit`} className="rounded-full bg-purple-800 text-white px-5 py-2.5 hover:bg-purple-900">Plan a Visit</a>
        </div>
