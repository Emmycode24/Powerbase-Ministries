...
const Footer = () => (
  <footer className="site-footer">
    <div className="footer-main">
      ...
      <div className="footer-contact"><p className="footer-label">Get in touch</p><p>powerbaseministry6@gmail.com</p><p>+2347025005487</p><p>16 AYO-OLOFINTUYI STREET BARUWA, P. O. BOX IPAJA LAGOS</p></div>
