...
const Footer = () => (
  <footer className="bg-slate-950 text-white px-6 py-12">
    <div className="max-w-6xl mx-auto grid gap-8 md:grid-cols-3">
      ...
      <div><h3 className="text-xl font-semibold mb-3">Contact Us :</h3><p className="text-gray-300">Email: info@powerbaseministry.org</p><p className="text-gray-300">Phone: +234 803 726 1478</p><p className="text-gray-300">Address: 16, Olofuntuyi Street, Baruwa Inside, Ipaja, Lagos State</p></div>
